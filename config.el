...
(setq user-full-name "Luis Fernando"
      user-mail-address "luisfmiranda8@gmail.com")
...
;;
;;
;;ACHICAR EL TAMANO DE VTERM
;; (after! vterm

     ;; (set-popup-rule! "*doom:vterm-popup" :size 0.20 :vslot -4 :select t :quit nil :ttl 0)
;; ;;   ;; (set-popup-rule! "*doom:vterm-popup:#1" :size 0.20 :vslot -4 :select t :quit nil :ttl 0)
;; ;;   ;; (set-popup-rule! "*doom:vterm-popup:#2" :size 0.20 :vslot -4 :select t :quit nil :ttl 0)
;; ;;   ;; (set-popup-rule! "*doom:vterm-popup:#3" :size 0.20 :vslot -4 :select t :quit nil :ttl 0)
;; ;;   ;; (set-popup-rule! "*doom:vterm-popup:#4" :size 0.20 :vslot -4 :select t :quit nil :ttl 0)
;;    ;; (set-popup-rule! "*doom:vterm-popup" :size 0.20, :select t :quit nil :ttl 0)
    ;; )
...
(map! :leader
      (:prefix-map ("m" . "Mias")
        (:prefix-map ("b" . "Bookmark")
        :desc "Set bookmark" "s" #'bm-toggle
        :desc "Jum to bookmark" "n" #'bm-next
        :desc "Jump to prev bookmark" "p" #'bm-previous);;
        ;;
        (:prefix-map ("d" . "Duplicar")
        :desc "Duplicar y comentar" "c" #'crux-duplicate-and-comment-current-line-or-region
        :desc "Duplicar linea" "l" #'crux-duplicate-current-line-or-region);;
        ;;
        (:prefix-map ("c" . "Comment")
        :desc "Uncommet region" "u" #'uncomment-region ;
        :desc "Commet line" "l" #'comment-line
        :desc "Commet region" "r" #'comment-region);;
        ;;
        (:prefix-map ("w" . "Wrap")
        :desc "Envolver en llaves" "l" #'sp-wrap-curly
        :desc "Desenvolver" "u" #'sp-unwrap-sexp
        :desc "Envolver en parentesis" "p" #'sp-wrap-round)

        ;;
        (:prefix-map ("e" . "Edit")
         :desc "edit multiple lines" "l" #'mc/edit-lines
         :desc "edit end of the lines" "e" #'mc/edit-ends-of-lines
         :desc "edit end of the lines" "i" #'mc/edit-beginnings-of-lines
        )))
...
(after! company
		  (setq +lsp-company-backends '(company-tabnine :separate company-capf company-yasnippet))
			  (setq company-idle-delay 0)
                          (set-popup-rule! "*lsp-help" :size 0.20 )
			  )
